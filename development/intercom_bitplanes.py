...
class Intercom_bitplanes(Intercom_buffer):
    ...
    def run(self):
        ...
        def receive_and_buffer():
            ...
            bitplanenumber, nrchannel, chunk_number, *bitplane = struct.unpack(self.packet_format, message)
            ...
            self._buffer[chunk_number % self.cells_in_buffer][:,msgchannel]+=msgout
        ...
        def record_send_and_play(indata, outdata, frames, time, status):
            ...
            for i in range(self.number_of_channels):
                ...
                for b in range(16)
                    ...
                    message = struct.pack(self.packet_format, (15-b), i, self.recorded_chunk_number, *(bitpack))
